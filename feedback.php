    ...
    <style>
        ...
        .feedback-visual {
            background: linear-gradient(rgba(0,0,0,0.3), rgba(0,0,0,0.3)),
                        url('Eimages/about5.jpg') center/cover no-repeat;
            min-height: 100%;
        }
        ...
        .form-input-minimal:focus ~ .label-minimal,
        .form-input-minimal:valid ~ .label-minimal {
            top: -20px;
            font-size: 0.6rem;
            color: var(--primary-gold);
            letter-spacing: 3px;
        ...
        @media (max-width: 768px) {
            .feedback-content { padding: 40px 25px; }
            ...
            <div class="row g-0">
                ...
                <div class="col-md-7 feedback-content">
                    ...
                    <div id="formContainer">
                        ...
                        <!--
                            NOTE: action points to feedback_submit.php (create this file later)
                            The JS below currently intercepts submit and shows a success message
                            When you build feedback_submit.php, remove e.preventDefault() and let the form POST normally
                        -->
                        <form id="luxuryFeedback" action="feedback_submit.php" method="POST" class="mt-5" autocomplete="off">
                            ...
                            <button type="submit" class="btn-submit-luxury">Submit Feedback</button>
                    ...
                    <div class="success-overlay" id="successMsg">
                        ...
                        <p class="mt-3" style="color: var(--text-silver); letter-spacing: 1px;">
