...
function get_percent($val, $total) { return ($total > 0) ? ($val / $total) * 100 : 0; }
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        /* Exact Styles from your Feedback Page */
        ...
        .bg-green-light { background: #f0fff4; color: #28a745; }
        .bg-blue-light { background: #f0f7ff; color: #007bff; }
        ...
        .panel { border: none; border-radius: 8px; }
            ...
            <div class="row g-4">
                <div class="col-12 col-lg-7">
                    <div class="panel p-4 bg-white shadow-sm h-100">
                        ...
                        <?php endwhile; else: echo "No data available"; endif; ?>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-5">
                    <div class="panel p-4 bg-white shadow-sm h-100">
                        ...
                        <div class="row g-2">
                            ...
                            <?php endwhile; else: echo "No trends found"; endif; ?>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <?php endwhile; else: ?>
                                        <tr><td colspan="4" class="p-4 text-center text-muted">No stylists recorded.</td></tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                        </div>
