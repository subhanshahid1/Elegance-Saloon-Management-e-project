...
if (isset($_POST['btn_add'])) {
    ...
    $desc = $conn->real_escape_string($_POST['add_description']);
    ...
    $sql = "INSERT INTO services (name, description, category, price, duration, status) VALUES ('$name', '$desc', '$cat', $pr, $dur, 'active')";
    $conn->query($sql);
...
if (isset($_POST['btn_update'])) {
    ...
    $desc = $conn->real_escape_string($_POST['upd_description']);
    ...
    $sql = "UPDATE services SET name='$name', description='$desc', category='$cat', price=$pr, duration=$dur, status='$st' WHERE id=$id";
