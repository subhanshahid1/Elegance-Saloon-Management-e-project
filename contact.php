    ...
    <div class="container">
      <div class="row g-0">
        ...
        <div class="col-12 col-md-6 pe-md-5 pb-5 pb-md-0">
          ...
          <!-- Here is the contact alert start -->

          <?php if (isset($_GET['msg'])): ?>
            <?php if ($_GET['msg'] == 'sent'): ?>
              <div class="alert alert-success" style="background: #d4a017; color: #000; border: none;">
                <strong>Success!</strong> Your message has been saved. Management will review it soon.
              </div>
            <?php endif; ?>

            <?php if ($_GET['msg'] == 'error'): ?>
              <div class="alert alert-danger" style="background: #ff4444; color: #fff; border: none;">
                <strong>Error!</strong> Something went wrong. Please try again.
              </div>
            <?php endif; ?>
          <?php endif; ?>

          <!-- Here is the contact alert end -->
